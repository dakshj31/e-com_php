...
<a href="item.php?id={$row['product_id']}"><img style="height:90px;" src="../resources/{$product_image}" alt=""></a>
    <div class="caption">
        ...
        <a class="btn btn-primary" target="_blank" href="item.php?id={$row['product_id']}" class="btn btn-default">More Info</a></p>
...
function display_images($picture) {
...
function get_products_in_admin() {
    ...
    while($row = fetch_array($query)) {
     ...
     $category = show_product_category_id($row['product_category_id']);
...
function show_product_category_id($product_category_id) {
